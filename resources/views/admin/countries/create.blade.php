...
@endif
    ...
    <option value="ar" data-name="Argentina" @selected(old('country') == 'ar')>Argentina (AR)</option>
    <option value="bo" data-name="Bolivia" @selected(old('country') == 'bo')>Bolivia (BO)</option>
    ...
    <option value="co" data-name="Colombia" @selected(old('country') == 'co')>Colombia (CO)</option>
    <option value="cr" data-name="Costa Rica" @selected(old('country') == 'cr')>Costa Rica (CR)</option>
    <option value="cu" data-name="Cuba" @selected(old('country') == 'cu')>Cuba (CU)</option>
    <option value="do" data-name="Dominican Republic" @selected(old('country') == 'do')>Dominican Republic (DO)</option>
    <option value="ec" data-name="Ecuador" @selected(old('country') == 'ec')>Ecuador (EC)</option>
    <option value="sv" data-name="El Salvador" @selected(old('country') == 'sv')>El Salvador (SV)</option>
    <option value="gt" data-name="Guatemala" @selected(old('country') == 'gt')>Guatemala (GT)</option>
    <option value="hn" data-name="Honduras" @selected(old('country') == 'hn')>Honduras (HN)</option>
    <option value="mx" data-name="Mexico" @selected(old('country') == 'mx')>Mexico (MX)</option>
    <option value="ni" data-name="Nicaragua" @selected(old('country') == 'ni')>Nicaragua (NI)</option>
    <option value="pa" data-name="Panama" @selected(old('country') == 'pa')>Panama (PA)</option>
    <option value="py" data-name="Paraguay" @selected(old('country') == 'py')>Paraguay (PY)</option>
    <option value="pe" data-name="Peru" @selected(old('country') == 'pe')>Peru (PE)</option>
    <option value="pr" data-name="Puerto Rico" @selected(old('country') == 'pr')>Puerto Rico (PR)</option>
    <option value="uy" data-name="Uruguay" @selected(old('country') == 'uy')>Uruguay (UY)</option>
    <option value="ve" data-name="Venezuela" @selected(old('country') == 've')>Venezuela (VE)</option>
</select>

{{-- Only country_name needs a hidden input --}}
<input type="hidden" id="country_name_hidden" name="country_name" value="{{ old('country_name') }}">
                    </div>
                    ...
                    <div class="card-body p-6 space-y-4">
                        <div class="flex flex-col gap-1.5 pb-3 border-b border-base-200">
                            ...
                            <p class="text-[11px] text-base-content/60">
                                Provide any necessary descriptive annotations, operational contexts, or exceptional baseline matrix notes for this country profile node.
                            </p>
                        </div>

                        <div class="flex flex-col gap-2 py-2">
                            <div class="relative flex items-start">
                                <span class="absolute left-4 top-3.5 text-neutral-400 pointer-events-none z-10">
